...
# Create subfigures
#fig, axes = plt.subplots(1, 2, figsize=(4.76,2.38))
fig, axes = plt.subplots(1, 2, figsize=(3.872,1.73))
...
# Formatting
#fig.set_figheight(2.38)
#fig.set_figwidth(4.76)
...
xticklabels = [r'${}$'.format(elem) for elem in ['0.05', '0.3', '0.5', '0.7', '0.95']]
...
xticklabels = [r'${:.1f}$'.format(elem) for elem in beta_x]
