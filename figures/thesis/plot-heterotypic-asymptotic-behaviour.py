...
ax1.set_title(r'$\textrm{{Cross Section I: }} \eta_B = {}, \beta_B = {}$'.format(eta_A1, beta_A1))
ax2.set_title(r'$\textrm{{Cross Section II: }} \eta_B = {}, \beta_B = {}$'.format(eta_A2, beta_A2))
ax3.set_title(r'$\textrm{{Cross Section III: }} \eta_B = {}, \beta_B = {}$'.format(eta_A3, beta_A3))
