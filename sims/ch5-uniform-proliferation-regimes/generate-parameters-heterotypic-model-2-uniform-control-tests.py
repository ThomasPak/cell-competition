...
simulation-id = betaA_{9:.2f}_tGA_{10:.2f}_etaA_{11:.2f}_coefA_{12:.2f}_rhoA_{13:.2f}_betaB_{14:.2f}_tGB_{15:.2f}_etaB_{16:.2f}_coefB_{17:.2f}_rhoB_{18:.2f}_Nx_{1}_Ny_{2}_pattern_{19}_sim_{20}
"""
          ...
          for Nx in Nxs:
           for pattern in patterns:
            for i in range(num_iter):
              ...
              uniform_g1_range_A = 2 * rho_A * tG_A
              uniform_g1_range_B = 2 * rho_B * tG_B
              ...
              uniform_g1_range_mapping = {0 : str(uniform_g1_range_A), 1 :
                      str(uniform_g1_range_B)}
              ...
              param_string = base_string.format(
                      ...
                      ','.join(map(uniform_g1_range_mapping.get, ancestors)),
                      beta_A,
                      tG_A,
                      eta_A,
                      coef_A,
