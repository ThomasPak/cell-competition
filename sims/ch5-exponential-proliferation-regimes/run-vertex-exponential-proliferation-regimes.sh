...
#SBATCH --job-name=exponential-proliferation-regimes
#SBATCH --output=exponential-proliferation-regimes_%A_%a.out
#SBATCH --error=exponential-proliferation-regimes_%A_%a.err
...
python3 generate-vertex-parameters-exponential-proliferation-regimes.py $sim_num | \
