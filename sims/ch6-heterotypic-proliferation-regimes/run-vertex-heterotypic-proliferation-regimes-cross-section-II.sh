...
#SBATCH --job-name=heterotypic-proliferation-regimes-cross-section-II
#SBATCH --output=heterotypic-proliferation-regimes-cross-section-II_%A_%a.out
#SBATCH --error=heterotypic-proliferation-regimes-cross-section-II_%A_%a.err
