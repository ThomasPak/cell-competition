...
#SBATCH --job-name=heterotypic-model-2-exponential-asymptotic-II-tests
#SBATCH --output=heterotypic-model-2-exponential-asymptotic-II-tests_%A_%a.out
#SBATCH --error=heterotypic-model-2-exponential-asymptotic-II-tests_%A_%a.err
