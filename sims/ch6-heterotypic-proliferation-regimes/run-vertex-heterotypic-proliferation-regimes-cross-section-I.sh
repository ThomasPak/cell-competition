...
#SBATCH --job-name=heterotypic-proliferation-regimes-cross-section-I
#SBATCH --output=heterotypic-proliferation-regimes-cross-section-I_%A_%a.out
#SBATCH --error=heterotypic-proliferation-regimes-cross-section-I_%A_%a.err
...
python3 generate-vertex-parameters-heterotypic-proliferation-regimes-cross-section-I.py $sim_num | \
