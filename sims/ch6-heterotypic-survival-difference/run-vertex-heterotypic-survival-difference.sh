...
#SBATCH --job-name=heterotypic-survival-difference
#SBATCH --output=heterotypic-survival-difference_%A_%a.out
#SBATCH --error=heterotypic-survival-difference_%A_%a.err
...
python3 generate-vertex-parameters-heterotypic-survival-difference.py $sim_num | \
