#ifndef TESTCUSTOMVERTEXBASEDCELLPOPULATION_HPP_
#define TESTCUSTOMVERTEXBASEDCELLPOPULATION_HPP_
...
class TestCustomVertexBasedCellPopulation : public AbstractCellBasedTestSuite
{
public:

    // Test construction, accessors and iterator
    void TestCreateSmallCustomVertexBasedCellPopulationAndGetWidth()
    {
        ...
        // Test CustomVertexBasedCellPopulation::Iterator
        for (CustomVertexBasedCellPopulation<2>::Iterator cell_iter = cell_population.Begin();
    ...
    void TestValidate()
    {
        ...
        TS_ASSERT_THROWS_THIS(CustomVertexBasedCellPopulation<2> cell_population(*p_mesh, cells_copy),
        ...
        TS_ASSERT_THROWS_NOTHING(CustomVertexBasedCellPopulation<2> cell_population(*p_mesh, cells_copy2));
        ...
        TS_ASSERT_THROWS_THIS(CustomVertexBasedCellPopulation<2> cell_population2(*p_mesh2, cells2, false, true, cell_location_indices2),
    ...
    void TestIsCellAssociatedWithADeletedLocation()
    {
        ...
        CustomVertexBasedCellPopulation<2> cell_population(*p_mesh, cells, false, false);
    ...
    void TestCustomVertexBasedCellPopulationWriteResultsToFile()
    {
        ...
        CustomVertexBasedCellPopulation<2> cell_population(*p_mesh, cells);
        cell_population.InitialiseCells();
        TS_ASSERT_EQUALS(cell_population.GetIdentifier(), "CustomVertexBasedCellPopulation-2");
        ...
        std::string output_directory = "TestCustomVertexBasedCellPopulationWriteResultsToFile";
    ...
    void TestArchiving2dCustomVertexBasedCellPopulation()
    {
        ...
        // Archive cell population
        {
            ...
            // Create cell population
            CustomVertexBasedCellPopulation<2>* const p_cell_population = new CustomVertexBasedCellPopulation<2>(mesh, cells);
        ...
        // Restore cell population
        {
            ...
            CustomVertexBasedCellPopulation<2>* p_cell_population;
            (*p_arch) >> p_cell_population;
    ...
    void TestArchiving3dCustomVertexBasedCellPopulation()
    {
        ...
        // Archive cell population
        {
            ...
            // Create cell population
            CustomVertexBasedCellPopulation<3>* const p_cell_population = new CustomVertexBasedCellPopulation<3>(mesh, cells);
        ...
        // Restore cell population
        {
            ...
            // Restore the cell population
            (*p_arch) >> *p_simulation_time;
            CustomVertexBasedCellPopulation<3>* p_cell_population;
            (*p_arch) >> p_cell_population;
    ...
    void TestGetTetrahedralMeshForPdeModifier()
    {
        ...
        // Create cell population
        CustomVertexBasedCellPopulation<2> cell_population(*p_vertex_mesh, cells);
...
#endif /*TESTCUSTOMVERTEXBASEDCELLPOPULATION_HPP_*/
